...
$('#ca_data_selector').submit(function() {
	...
	$('#status').css("visibility", "visible"); //testing whether this will allow the status message to appear while trips are loading		
	...
	$('#status').css("display", "none"); //testing whether this will allow the status message to appear while trips are loading		
