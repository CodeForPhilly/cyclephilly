...
<link rel="stylesheet" href="http://cdn.leafletjs.com/leaflet-0.7/leaflet.css" />
   ...
   <!-- Main site js css -->  
      ...
      <link rel="stylesheet" href="./css/animate.min.css"> <!-- adding animation css -->
...
<body lang="en">
  ...
  <div id="branding"><a href="http://www.cyclephilly.org" ><div id="logo"><img class="img-responsive" src="img/logo.png"/></div><div id="cyclephilly">CyclePhilly</div><span id="ride">Ride. Record. Reimagine Your Routes.</span></a></div>
...
<div class="animated pulse infinite pad-5" id="status"><span class="marg-loading" id ="loading">loading tracks</span><img class="no-scale marg-logo" src="img/logo112w.png"/></div>
<!-- pulsing animation logo courtesy of https://github.com/daneden/animate.css -->

  </section>

  <section class="float-left" id="selector">
<!-- <p id="chunk1" class="pad-5 marg-top-5">Want to see the tracks your fellow cyclists are carving throughout the City? </br></br> Just select one or multiple trip types (ctrl+click on a pc or command+click on a mac) and then hit 'Make Tracks'</p> -->
<div id="container" style="color=#ffffff;"></div> 
<p id="chunk1" class="pad-5 marg-top-5">Want to see the tracks your fellow cyclists are carving throughout the city and region? </br></br> Just select a trip type and 'Make Tracks.'</p>
...
<!--         <form id="ca_data_selector" action="#" class="float-left pad-5">
 ...
 <!-- <p><input type="text" id="search" list="ca_data_selector_field" placeholder="Select trip purpose"></p> -->
              <select id="ca_data_selector_field" class="float-left pad-5">
              <!-- <datalist id="Ride Purpose:"> -->
              <option value="Commute">Commute</option>
              <option value="School">School</option>
              <option value="Work-Related">Work Related</option>
...
<script src="js/main_heat.js"></script>
<!-- <script src="js/main_testing.js"></script> -->
