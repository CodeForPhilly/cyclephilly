...
$(document).ready(function(){
  ...
  google.maps.event.addDomListener(window, 'load',function (e){
    ...
    var mapOptions = {
      zoom: 13,
      center: new google.maps.LatLng(39.9633407,-75.1402496),
    ...
    //Get Points
    var params = {purpose:'Commute',window:'4'};
    
    $.getJSON( "jsonservice/trips/heat.json",params)
    .done(function( data ) {
      var tripData = [];
      $.each( data.response, function( key, val ) {
        tripData.push(new google.maps.LatLng(val[0],val[1]));
        //console.log(val);

      });
      var pointArray = new google.maps.MVCArray(tripData);
